...
public abstract class AbstractUVCCameraHandler extends Handler {
    ...
    private static final int MSG_AUTO_WHITE_BALANCE_START = 11;
    private static final int MSG_AUTO_WHITE_BALANCE_STOP = 12;
    // 音频线程
...
//	}
    ...
    public void startAutoWhiteBalance() {
        sendMessage(obtainMessage(MSG_AUTO_WHITE_BALANCE_START));
    }

    public void stopAutoWhiteBalance(){
        sendMessage(obtainMessage(MSG_AUTO_WHITE_BALANCE_STOP));
    }
...
//			thread.handleStartRecording((String)msg.obj);
            ...
            case MSG_CAMERA_FOUCS:
                ...
                break;
            case MSG_AUTO_WHITE_BALANCE_START:
                thread.handleAutoWhiteBalance();
                break;
            default:
...
//				}
        ...
        public void handleAutoWhiteBalance() {
            if ((mUVCCamera == null) || !mIsPreviewing)
                return;
